...
module MTLibcouchbase
    ...
    class Error < ::StandardError
        class UnknownError < ::MTLibcouchbase::Error; end
        class HttpResponseError < ::MTLibcouchbase::Error
        ...
        Ext::ErrorT.symbols.map { |val|
            ...
            Lookup[enum] = begin
                ...
                ::MTLibcouchbase::Error.const_get(name)
            rescue NameError => e 
                # Build the constants
                klass = Class.new(::MTLibcouchbase::Error)
                ::MTLibcouchbase::Error.const_set(name, klass)
                klass
            end
        end
